          ...
          <ReactCardFlip isFlipped={this.state.isFlipped}>
            ...
            <TeamCardBack onClick={this.handleClick}>
              ...
              <CloseButton src={closeicon} onClick={this.handleClick}></CloseButton>
                ...
                <TeamP>Sharon is the Co-founder and the Executive Vice President of Operations at People’s Wealth. Sharon joined People’s Wealth in order to maximize awareness among students of helpful student loan programs that exist in the hopes of bringing them financial relief. In her spare time, Sharon enjoys traveling, going on roadtrips, building PCs, and riding her longboard around town while frequenting new places. Her goal is to eventually cook a mean meal without burning one of the dish components.</TeamP>
            </TeamCardBack>
          </ReactCardFlip>
